...
OctBlogSettings = {
    ...
    'donation': {
        ...
        'donation_img_url': os.environ.get(
            'donation_img_url') or 'http://img-own.igevin.info/weixin-pay.jpg?imageView/2/w/300'
    },
    'wechat': {
        'display_wechat': os.environ.get('display_wechat', 'true').lower() == 'true',
        'wechat_msg': get_env_value('wechat_msg', 'Welcome to follow my wechat'),
        'wechat_image_url': os.environ.get(
            'wechat_image_url') or 'http://7tsygu.com1.z0.glb.clouddn.com/gevin-view.jpg?imageView/2/w/150',
    ...
    'daovoice': {
        'allow_daovoice': (os.environ.get('allow_daovoice', 'false').lower() == 'true' and os.environ.get(
            'daovoice_app_id') is not None),
